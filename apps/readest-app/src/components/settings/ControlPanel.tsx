        ...
        {!isDisableDoubleClick && (
          <>
            ...
            {doubleClickSelectionBehavior !== 'toolbar' && (
              <div className='my-2 flex flex-col border-l border-base-200 ml-4 pl-4 gap-1'>
                    ...
                    <SettingsRow
                      ...
                      label={
                        <div className='flex flex-col'>
                          ...
                          {(opt.value === 'dictionary' || opt.value === 'translate') && (
                            <span
                              className={`text-[10px] text-base-content/40 ${isOptionDisabled(opt.value) ? 'opacity-50' : ''}`}
                            >
                              {opt.value === 'dictionary'
                                ? _('Can be co-selected with Translate')
                                : _('Can be co-selected with Dictionary')}
                            </span>
                          )}
                        </div>
                      }
